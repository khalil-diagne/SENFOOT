-- =============================================================================
-- Dribbleur Store — Export complet base `efootball`
-- =============================================================================
-- CHEMINS DES PHOTOS (fichiers physiques, à copier avec ce SQL) :
--   uploads/articles/   → colonnes articles.image et articles.gallery_images (JSON)
--   uploads/avatars/    → colonne visiteur.avatar
--   uploads/kyc/        → colonne visiteur.seller_id_photo
--
-- En base : seulement le nom du fichier (ex: 6c57d36bddb77ded.jpg)
-- URL web : uploads/articles/6c57d36bddb77ded.jpg
--
-- Détail article par article : voir sql/CHEMINS_PHOTOS.txt
-- =============================================================================
...
-- Dump completed on 2026-05-21 23:51:23
